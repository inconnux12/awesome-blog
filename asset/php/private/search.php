...
elseif($_GET['type']=='cat'){
    ...
    while($row=$res->fetch_assoc()){
        echo'<tr>
        <td>'.$row['name_cat'].'</td>
        <td style="text-align:center;"><a href="mody.php?type=cat&id='.$row['id_cat'].'" class="blue darken-4 waves-light btn-large clr-btn">modify</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="asset/php/private/supp_p.php?type=cat&id='.$row['id_cat'].'" class="red accent-4 waves-light btn-large clr-btn">delete</a></td>
    </tr>';
    }
}
?>