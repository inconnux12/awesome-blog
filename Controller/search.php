...
elseif($action=='q'){
    $sql= "select * from categorie , publications where (title_pub LIKE '%".$q."%'or name_cat LIKE '%".$q."%' or desc_pub LIKE '%".$q."%'or cont_pub LIKE '%".$q."%') and publications.id_cat = categorie.id_cat";
    $res=$con->query($sql)  or die($con->error);
